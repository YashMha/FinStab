...
def generate_pdf_report(results, weekly_income, worker_type, city, dependents, monthly_exp, ai_insights, worker_name="", L=None):
    ...
    try:
        ...
        # ── Header ──
        header_content = [
            [Paragraph("WageWise", sty("T", fontSize=20, fontName="Helvetica-Bold", textColor=white, alignment=TA_CENTER))],
        ...
        story += [
            ...
            Paragraph("Generated by WageWise  |  Free financial planning for gig workers in India",
...
# PAGE CONFIG
# ══════════════════════════════════════════════════════════
st.set_page_config(page_title="WageWise", page_icon="🛡️",
...
<div class="topbar">
  <div class="topbar-brand">
    ...
    <div class="topbar-name">Wage<span>Wise</span></div>
  </div>
...
# ══════════════════════════════════════════════════════════
    ...
    st.plotly_chart(fig, use_container_width=True, config={
        ...
        "toImageButtonOptions": {"format": "png", "filename": "wagewise_chart", "scale": 2},
    })
    ...
    with dlc:
        st.download_button(
            ...
            data=pdf_bytes,
            file_name="wagewise_report.pdf" if is_pdf else "wagewise_report.txt",
